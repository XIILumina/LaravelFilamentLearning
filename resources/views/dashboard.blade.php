    ...
    <div class="flex h-full w-full flex-1 flex-col gap-6 rounded-xl p-6">
        ...
        <div class="grid auto-rows-min gap-4 md:grid-cols-3">
            <div class="bg-zinc-800 rounded-xl p-6 border border-zinc-700">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-zinc-400 text-sm">Total Games</p>
            ...
            <div class="bg-zinc-800 rounded-xl p-6 border border-zinc-700">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-zinc-400 text-sm">My Wishlist</p>
        ...
        <div class="grid gap-6 md:grid-cols-2">
            ...
            <div class="bg-zinc-800 rounded-xl p-6 border border-zinc-700">
                ...
                @if($recentWishlist->count() > 0)
                    <div class="space-y-3">
                        @foreach($recentWishlist as $game)
                            <div class="flex items-center space-x-3 p-3 bg-zinc-700 rounded-lg">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-zinc-400 text-sm">{{ $game->developer->name ?? 'Unknown' }}</p>
                                </div>
                ...
                @else
                    <div class="text-center py-8">
                        <p class="text-zinc-400 mb-3">Your wishlist is empty</p>
            ...
            <div class="bg-zinc-800 rounded-xl p-6 border border-zinc-700">
                ...
                <div class="space-y-3">
                    <a href="{{ route('games.index') }}" class="flex items-center space-x-3 p-3 bg-zinc-700 hover:bg-zinc-600 rounded-lg transition-colors">
                        ...
                        <div>
                            ...
                            <p class="text-zinc-400 text-sm">Explore our game database</p>
                        </div>
                    </a>

                    <a href="{{ route('genres.index') }}" class="flex items-center space-x-3 p-3 bg-zinc-700 hover:bg-zinc-600 rounded-lg transition-colors">
                        ...
                        <div>
                            ...
                            <p class="text-zinc-400 text-sm">Find games by category</p>
                        </div>
                    </a>

                    <a href="{{ route('wishlist.index') }}" class="flex items-center space-x-3 p-3 bg-zinc-700 hover:bg-zinc-600 rounded-lg transition-colors">
                        ...
                        <div>
                            ...
                            <p class="text-zinc-400 text-sm">View saved games</p>
                        </div>
                    </a>
                </div>
            </div>
