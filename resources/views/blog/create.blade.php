    ...
    <div class="min-h-screen bg-zinc-950">
        ...
        <div class="px-4 sm:px-6 py-4 border-b border-zinc-800 sticky top-0 bg-zinc-950/95 backdrop-blur-lg z-40">
            <div class="max-w-2xl mx-auto flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <h1 class="text-lg font-semibold text-white">Create Post</h1>
                </div>
        ...
        <div class="px-4 sm:px-6 py-6 pb-24 sm:pb-12">
            <div class="max-w-2xl mx-auto">
                <form id="create-post-form" method="POST" action="{{ route('blog.store') }}" enctype="multipart/form-data" class="space-y-5">
                    @csrf
                    ...
                    <!-- Photo Upload -->
                    <div>
                        <div class="bg-zinc-900 border border-zinc-800 border-dashed rounded-2xl overflow-hidden hover:border-zinc-700 transition">
                            <input type="file" 
                                   name="photo" 
                                   id="photo"
                                   accept="image/*"
                            ...
                            <label for="photo" class="cursor-pointer block">
                                <div id="upload-placeholder" class="p-8 text-center">
                                    ...
                                    <p class="text-zinc-400 text-sm">Add an image</p>
                ...
                <!-- Tips -->
                <div class="mt-8 bg-zinc-900 border border-zinc-800 rounded-2xl p-5">
                    ...
                    <ul class="space-y-2 text-sm text-zinc-400">
                        <li class="flex items-start gap-2">
                            ...
                            Use a descriptive, engaging title
                        </li>
                        <li class="flex items-start gap-2">
                            <span class="text-orange-500 mt-0.5">•</span>
                            Tag the relevant game to reach interested players
                        </li>
                        <li class="flex items-start gap-2">
                            <span class="text-orange-500 mt-0.5">•</span>
