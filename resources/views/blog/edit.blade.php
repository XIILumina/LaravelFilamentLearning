<x-layouts.app title="Edit Post">
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="mb-8">
            ...
            <h1 class="text-4xl font-bold text-white">Edit Post</h1>
            <p class="text-zinc-400">Update your post content</p>
        </div>
            ...
            <form method="POST" action="{{ route('blog.update', $post) }}" enctype="multipart/form-data" class="space-y-6">
                ...
                <div>
                    <label for="photo" class="block text-sm font-medium text-zinc-300 mb-2">
                        {{ $post->photo ? 'Change Photo (Optional)' : 'Photo (Optional)' }}
                    </label>
                        ...
                        <label for="photo" class="cursor-pointer">
                            <div id="upload-placeholder">
                                ...
                                <p class="text-zinc-400 mb-1">
                                    {{ $post->photo ? 'Click to change image' : 'Click to upload an image' }}
                                </p>
